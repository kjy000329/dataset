...
class Dataset_3DCNN(data.Dataset):
    ...
    def read_images(self, path, selected_folder, use_transform):
        ...
        for i in self.frames:
            image = Image.open(os.path.join(selected_folder, 'img' + str(i) + '.png'.format(i))).convert('L')
...
class CNN3D(nn.Module):
    def __init__(self, t_dim=28, img_x=240, img_y=320, drop_p=0.2, fc_hidden1=128, fc_hidden2=128, num_classes=2):
